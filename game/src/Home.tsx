...
const Home: React.FC = () => {
  ...
  return (
    <main className="text-red-600 w-85 mx-auto bg-green-200 text-left p-20">
      ...
      {url && (
        <img
          className="avatar-img h-75 w-75 border-2 border-purple-600 rounded-full"
          src={url}
          alt="Avatar"
        />
      )}
      ...
      <button
        onClick={startGame}
        className="mt-25 bg-pink-600 border-2 border-yellow-500 rounded-md py-2 px-4 text-white"
      >
        {url ? (
